...
protected:
    ...
    void UpdateFromArgs(const ArgsManager& args)
    {
        ...
        accept_discounted_ct = args.GetBoolArg("-accept_discounted_ct", true);
        create_discounted_ct = args.GetBoolArg("-create_discounted_ct", false);
...
public:
    ...
    void UpdateFromArgs(const ArgsManager& args)
    {
        ...
        accept_discounted_ct = args.GetBoolArg("-accept_discounted_ct", accept_discounted_ct);
        create_discounted_ct = args.GetBoolArg("-create_discounted_ct", create_discounted_ct);
