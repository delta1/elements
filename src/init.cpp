...
void SetupServerArgs(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-accept_discounted_ct", "Accept discounted fees for Confidential Transactions (default: true)", ArgsManager::ALLOW_ANY, OptionsCategory::CHAINPARAMS);
    argsman.AddArg("-create_discounted_ct", "Create Confidential Transactions with discounted fees (default: false)", ArgsManager::ALLOW_ANY, OptionsCategory::CHAINPARAMS);
