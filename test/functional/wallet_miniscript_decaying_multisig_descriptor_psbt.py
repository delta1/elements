...
class WalletMiniscriptDecayingMultisigDescriptorPSBTTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_approx(multisig.getbalance()['bitcoin'], deposit_amount, vspan=0.001)
        ...
        for locktime in [0] + self.locktimes:
            ...
            self.generate(self.node, 1)
            assert_approx(multisig.getbalance()['bitcoin'], deposit_amount - sent, vspan=0.001)
            assert_equal(receiver.getbalance()['bitcoin'], sent)
