...
class WalletMigrationTest(BitcoinTestFramework):
    ...
    def assert_is_sqlite(self, wallet_name):
        wallet_file_path = os.path.join(self.nodes[0].datadir, "elementsregtest/wallets", wallet_name, self.wallet_data_filename)
    ...
    def test_direct_file(self):
        ...
        wallets_dir = os.path.join(self.nodes[0].datadir, "elementsregtest", "wallets")
