...
BASE_SCRIPTS = [
    ...
    'feature_fedpeg.py --pre_transition --descriptors',
    'feature_fedpeg.py --post_transition --legacy-wallet',
    'feature_fedpeg.py --post_transition --descriptors',
    'feature_mandatory_coinbase.py',
    'feature_dynafed.py --legacy-wallet',
    'feature_dynafed.py --descriptors',
    ...
    'feature_connect_genesis_outputs.py --descriptors',
    'feature_block_v4.py',
    ...
    'wallet_elements_regression_1172.py --descriptors',
    'wallet_elements_regression_1259.py --legacy-wallet',
    'wallet_elements_regression_1259.py --descriptors',
    'wallet_elements_21million.py --legacy-wallet',
    'wallet_elements_21million.py --descriptors',
    'wallet_elements_dust_relay.py --legacy-wallet',
    'wallet_elements_dust_relay.py --descriptors',
    # Longest test should go first, to favor running tests in parallel
    # vv Tests less than 5m vv
    'feature_taproot.py',
    'feature_block.py',
    'wallet_elements_regression_1263.py --legacy-wallet',
    'wallet_elements_regression_1263.py --descriptors',
    ...
    'wallet_elements_regression_fundrawtransaction.py --descriptors',
    ...
    'feature_pegin_subsidy.py --descriptors',
